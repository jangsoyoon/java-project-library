					...
					<tbody>
									...
									<tr>
										...
										<td width="490" align="left" bgcolor="ffffff"
											...
											<select name="notice_status">
												<option value="신청접수" selected>${notice.notice_status}</option>
											</select>
										</td>
									</tr> --%>
						<tr>
						...
						<%-- <tr>
										...
										<td width="490" align="left" bgcolor="ffffff"
											...
											<option value="건강/취미/레저" ${(notice.category_name=='건강/취미/레저')?'selected':''}>건강/취미/레저</option>
											<option value="경제경영" ${(notice.category_name=='경제경영')?'selected':''}>경제경영</option>
											<option value="고전" ${(notice.category_name=='고전')?'selected':''}>고전</option>
											<option value="과학" ${(notice.category_name=='과학')?'selected':''}>과학</option>
											<option value="만화" ${(notice.category_name=='만화')?'selected':''}>만화</option>
											<option value="사회과학" ${(notice.category_name=='사회과학')?'selected':''}>사회과학</option>
											<option value="소설/시/희곡" ${(notice.category_name=='소설/시/희곡')?'selected':''}>소설/시/희곡</option>
											<option value="기타" ${(notice.category_name=='기타')?'selected':''}>기타</option>	
											</select>
											</td>
									</tr> --%>
						<tr>
